<div class="bg-slate-50 dark:bg-gray-900 text-gray-900 dark:text-white py-8 sm:py-12 rounded-md">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <h2 class="text-base/7 font-semibold text-indigo-600 dark:text-indigo-400">Training Dashboard</h2>
        <p class="mt-2 max-w-lg text-4xl font-semibold tracking-tight text-pretty text-gray-900 dark:text-white sm:text-5xl">
            Training Calendar
        </p>

        <!-- Training Dashboard Widget (Full Width) -->
        <div class="mt-10 sm:mt-16">
            <div class="bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl shadow-2xl dark:shadow-none p-6 relative">
                <!-- Header row -->
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center gap-3">
                        <img src="/images/logo.png" alt="AthletOS" class="h-8 w-auto" />
                        <span class="font-semibold text-gray-900 dark:text-white text-lg sm:text-xl">Training Dashboard</span>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <button wire:click="today" class="rounded bg-gray-100 dark:bg-gray-700 hover:bg-blue-100 dark:hover:bg-blue-900 px-3 py-2 text-sm font-semibold text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 focus:outline-none">Today</button>
                ...
                <div class="space-y-3 mb-6">
                    ...
                    <div class="h-10 bg-blue-100 dark:bg-blue-900/30 rounded flex items-center px-4">
                        <div class="w-2 h-2 bg-blue-600 dark:bg-blue-400 rounded-full mr-3"></div>
                        <span class="text-base text-gray-700 dark:text-gray-200">{{ $exercise->exercise->displayName() }}</span>
                        <span class="ml-auto text-sm text-gray-500 dark:text-gray-400">{{ $exercise->sets }} sets × {{ $exercise->reps }} reps</span>
                    </div>
                    @empty
                    <div class="h-10 bg-gray-100 dark:bg-gray-700 rounded flex items-center px-4 text-gray-400 dark:text-gray-500">No exercises scheduled for today.</div>
                    @endforelse
                </div>
                <!-- Bottom row -->
        ...
        <div class="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6">
            ...
            <div class="flex p-px lg:col-span-3">
                <div class="w-full overflow-hidden rounded-lg bg-white dark:bg-gray-800 shadow-lg shadow-gray-200/50 dark:shadow-none border border-gray-200/50 dark:border-white/15 lg:rounded-bl-4xl">
                    <div class="p-6">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center gap-2 px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg">
                                ...
                                <div>
                                    <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $this->metrics->currentStreak }}</p>
                            ...
                            <div class="flex items-center gap-2 px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg">
                                ...
                                <div>
                                    <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $this->metrics->totalWorkouts }}</p>
            ...
            <div class="flex p-px lg:col-span-3">
                <div class="w-full overflow-hidden rounded-lg bg-white dark:bg-gray-800 shadow-lg shadow-gray-200/50 dark:shadow-none border border-gray-200/50 dark:border-white/15 lg:rounded-br-4xl">
                    <div class="p-6">
                        <div class="space-y-3">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="w-full bg-gray-700 rounded-full h-2" role="progressbar" aria-valuenow="{{ $this->metrics->getPhaseProgressPercentage() }}" aria-valuemin="0" aria-valuemax="100">
                                    <div class="bg-blue-600 h-2 rounded-full transition-all duration-300"
                                        style="width: {{ $this->metrics->getPhaseProgressPercentage() }}%"></div>
                                </div>
            ...
            <div class="flex p-px lg:col-span-6">
                <div class="w-full overflow-hidden rounded-lg bg-white dark:bg-gray-800 shadow-lg shadow-gray-200/50 dark:shadow-none border border-gray-200/50 dark:border-white/15 max-lg:rounded-b-4xl">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2 mb-4">
                        ...
                        <div class="grid gap-4 md:grid-cols-3">
                            ...
                            <div class="text-center p-4 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg">
                                <p class="text-2xl font-bold text-gray-900 dark:text-blue-400">{{ $oneRepMax->current > 0 ? $oneRepMax->current . ' kg' : 'Not set' }}</p>
                                <p class="text-sm text-gray-600 dark:text-gray-400">{{ $oneRepMax->exercise->oneRepMaxDisplayName() }}</p>
                            ...
                            @else
                            <div class="text-center p-4 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg">
                                <p class="text-sm text-gray-600 dark:text-gray-400">No 1RM data available</p>
