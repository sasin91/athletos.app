...
it('calculates static progression for beginner squat', function () {
    ...
    expect($squatProgression)->not->toBeNull();
    ...
    foreach ($squatProgression->dataPoints as $i => $point) {
        expect($point['expected_weight'])->toBe($expectedWeights[$i]);
    }
});

it('calculates percentage progression for advanced squat', function () {
    $athlete = Athlete::factory()->create([
