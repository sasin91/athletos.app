...
#[openapi(
    ...
    paths(
        ...
        crate::routes::workout_definitions::list,
        crate::routes::workout_definitions::create,
        crate::routes::workout_definitions::get,
        crate::routes::workout_definitions::update,
        crate::routes::workout_definitions::archive,
        crate::routes::workout_definitions::copy,
        crate::routes::workout_definitions::list_shares,
        crate::routes::workout_definitions::create_share,
        crate::routes::workout_definitions::revoke_share,
        crate::routes::workout_definitions::preview_share,
        crate::routes::workout_definitions::copy_share,
        crate::routes::editable_workouts::prepare,
        crate::routes::editable_workouts::blank,
        crate::routes::editable_workouts::submit,
        crate::routes::editable_workouts::materialize_saved,
        crate::routes::editable_workouts::history,
        crate::routes::editable_workouts::show,
        crate::routes::editable_workouts::progress,
    ),
    components(schemas(
        crate::routes::health::Health,
        ...
        crate::routes::enrollments::ReadoutView,
    ...
    tags(
        ...
        (name = "exercises", description = "The compiled-in exercise registry (D-03, D-04)"),
